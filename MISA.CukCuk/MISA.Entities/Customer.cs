...
namespace MISA.Entities
{
    public class Customer
    {
        public static List<Customer> Customers = new List<Customer>()
        {
            ...
            new Customer(){ CustomerCode="NV004", CustomerName="Chu Trần Đại", Gender="Nam", DateOfBrith=new DateTime(1997, 10, 4), Address="Số 3 Cầu Giấy, Láng Thượng, Đống Đa, Hà Nội", Email="daidz@gmail.com", SDT="23654121277", DebtMoney=1000000},
